...
#' Prints summary of \code{augmentedRCBD.menv} object
#'
#' \code{print.augmentedRCBD.menv} prints to console the summary of an object of
#' class \code{augmentedRCBD.menv} including the augmented design details, ANOVA
...
#'
#' @param x An object of class \code{augmentedRCBD.menv}.
#' @param ... Unused
#' @seealso \code{\link[augmentedRCBD]{augmentedRCBD.menv}}
#'
#' @export
print.augmentedRCBD.menv <- function(x, ...){
  ...
  nenv <- Details$`Number of environments`
