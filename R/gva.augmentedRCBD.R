...
#'
#' \code{gva.augmentedRCBD} performs genetic variability analysis on an object
#' of class \code{augmentedRCBD}. \loadmathjax
#'
...
#' (\mjseqn{\sigma^{2}_{p}}, \mjseqn{\sigma^{2}_{g}} and \mjseqn{\sigma^{2}_{e}}
...
#'
#' \tabular{ll}{ \emph{\strong{GAM}} \tab \strong{Category} \cr x \mjseqn{ < }
#' 10 \tab Low \cr 10 \mjseqn{\le} x \mjseqn{ < } 20 \tab Medium \cr
#' \mjseqn{\ge} 20 \tab High }
#'
...
#'   \insertCite{johnson_estimates_1955}{augmentedRCBD}.} \item{GAM
#'   category}{The \mjseqn{GAM} category according to
