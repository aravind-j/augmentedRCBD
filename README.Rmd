...
[![develVersion](https://img.shields.io/badge/devel%20version-`r gsub("Version:\\s*", "", readLines(paste0("https://raw.githubusercontent.com/", "aravind-j/augmentedRCBD", "/master/DESCRIPTION"))[grep("Version:", readLines(paste0("https://raw.githubusercontent.com/", "aravind-j/augmentedRCBD", "/master/DESCRIPTION")))])`-orange.svg)](https://github.com/aravind-j/augmentedRCBD)
...
```
The vignette for the latest version is also available [online](https://aravind-j.github.io/augmentedRCBD/articles/How_to_Use_augmetedRCBD.html).
