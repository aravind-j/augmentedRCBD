...
###### Version : [`r getNamespaceVersion("augmentedRCBD")`](https://aravind-j.github.io/augmentedRCBD/articles/Data_Analysis_with_augmentedRCBD.html#install); Copyright (C) 2015-`r  format(Sys.Date(), "%Y")`: [ICAR-NBPGR](https://nbpgr.org.in/); License: [GPL-2|GPL-3](https://www.r-project.org/Licenses/)
